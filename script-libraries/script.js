...
//get searched input into local storage
//apply saved input into button on the left
// VALUE TO KEEP IN STORAGE: document.getElementById('name').value
//get information to show
//

/// when the page is loaded you need to retrieve the info from localsotrage and build the btn and add event lisneter 

//searched city 5 day weather forecast

//function that searches the value of the input
